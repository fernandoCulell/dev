...
module.exports.main = function (ffCollection, vvClient, response) {
    ...
    var commLogTemplateID = "Communication Log"; //When createCommLog is true, this is the template name of the Communications Log. Used to post form.
    ...
    */
    ...
    var randomPassword = function () {
        ...
        for (var i = 0; i < PasswordLength; i++) text += passwordChars.charAt(Math.floor(Math.random() * passwordChars.length));
