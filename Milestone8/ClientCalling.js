// Service for Service Provided

var webServiceName = "ServiceInvoice";
var formName = "Service Provided";
        ...
        if (errorOnConnection) {
            ...
            if (wsSentResponse) {
                if (wsSentSuccessResponse) {
                    ...
                    VV.Form.SetFieldValue("Invoice Record", resp.data[2].data.instanceName)
                        .then(() => VV.Form.SetFieldValue("Submitted", true))
