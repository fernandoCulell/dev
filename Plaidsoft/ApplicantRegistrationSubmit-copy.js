...
module.exports.main = async function (ffCollection, vvClient, response) {
  ...
  try {
    ...
    ******************/
    ...
    //// For local testing ////
    const scriptToExecute1 = require("../z_Plaidsoft/LibEmailGenerateAndCreateCommunicationLog.js");
    const ffcol1 = new clientLibrary.forms.formFieldCollection(
      emailRequestArray
    );
    const createUserResp = await scriptToExecute1.main(
      ffcol1,
      vvClient,
      response
    );
    ...
    */
    ...
    //// For local testing ////
    const scriptToExecute2 = require("../z_Plaidsoft/LibFormUpdateorPostandRelateFormAsyncAwait.js");
    const ffcol2 = new clientLibrary.forms.formFieldCollection(formData);
    const postResp = await scriptToExecute2.main(ffcol2, vvClient, response);
    //// End local testing ////
    /* 
    ...
    //// For local testing ////
    const scriptToExecute3 = require("../z_Plaidsoft/LibFormUpdateorPostandRelateFormAsyncAwait.js");
    const ffcol3 = new clientLibrary.forms.formFieldCollection(formData);
    postResp = await scriptToExecute3.main(ffcol3, vvClient, response);
    //// End local testing ////
    /* 
    ...
    //// For local testing ////
    const scriptToExecute4 = require("../z_Plaidsoft/LibFormUpdateorPostandRelateFormAsyncAwait.js");
    const ffcol4 = new clientLibrary.forms.formFieldCollection(formData);
    postResp = await scriptToExecute4.main(ffcol4, vvClient, response);
    //// End local testing ////
    /* 
    postResp = await vvClient.scripts.runWebService(
      "LibFormUpdateorPostandRelateFormAsyncAwait",
    ...
    //// For local testing ////
    const scriptToExecute5 = require("../z_Plaidsoft/LibFormUpdateorPostandRelateFormAsyncAwait.js");
    const ffcol5 = new clientLibrary.forms.formFieldCollection(formData);
    postResp = await scriptToExecute5.main(ffcol5, vvClient, response);
    //// End local testing ////
    /* 
    postResp = await vvClient.scripts.runWebService(
      "LibFormUpdateorPostandRelateFormAsyncAwait",
    ...
    //vvClient.scripts.runWebService("LibCopyFiles", benefitsParams);
    ...
    //// For local testing ////
    const scriptToExecute7 = require("../z_Plaidsoft/LibCopyFiles.js");
    const ffcol7 = new clientLibrary.forms.formFieldCollection(policiesParams);
    scriptToExecute7.main(ffcol7, vvClient, response);
    //// End local testing ////

    //vvClient.scripts.runWebService("LibCopyFiles", policiesParams);
    ...
    //// For local testing ////
    const scriptToExecute8 = require("../z_Plaidsoft/LibCopyFiles.js");
    const ffcol8 = new clientLibrary.forms.formFieldCollection(
      resumesMainParams
    );
    const ffcol9 = new clientLibrary.forms.formFieldCollection(resumesParams);
    scriptToExecute8.main(ffcol8, vvClient, response).then(() => {
      scriptToExecute8.main(ffcol9, vvClient, response);
    });
    //// End local testing ////
    /* 
    vvClient.scripts
      ...
      .then(() =>
        vvClient.scripts.runWebService("LibCopyFiles", resumesParams)
      );
       */
